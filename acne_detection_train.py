...
with stg.scope(): # 모델 관련 컴포넌트가 mirroedstrategy를 사용해 여러 gpu에 걸쳐 동기화되게 설정
    ...
    backbone = keras_cv.models.YOLOV8Backbone.from_preset("yolo_v8_m_backbone", include_rescaling = True)
    ...
    my_callbacks = [ModelCheckpoint('yolo_acne_detection.h5', monitor = 'val_loss',save_best_only = True, save_weights_only = True),
